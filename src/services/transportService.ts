...
const mockSchedules: TransportSchedule[] = [
  ...
  {
    id: '35',
    transportNumber: '18629',
    transportName: 'Ranchi - Jharsuguda Express',
    transportType: 'train',
    fromStation: 'RNC',
    toStation: 'JSG',
    departureTime: '22:30',
  ...
  {
    id: '36',
    transportNumber: '18630',
    transportName: 'Jharsuguda - Ranchi Express',
    transportType: 'train',
    fromStation: 'JSG',
    toStation: 'RNC',
    departureTime: '20:45',
  ...
  {
    id: '37',
    transportNumber: '13347',
    transportName: 'Ranchi - Bokaro Intercity',
    transportType: 'train',
    fromStation: 'RNC',
    toStation: 'BKSC',
    departureTime: '13:15',
  ...
  {
    id: '38',
    transportNumber: '13348',
    transportName: 'Bokaro - Ranchi Intercity',
    transportType: 'train',
    fromStation: 'BKSC',
    toStation: 'RNC',
    departureTime: '18:30',
  ...
  {
    id: '39',
    transportNumber: '18635',
    transportName: 'Dhanbad - Jharsuguda Express',
    transportType: 'train',
    fromStation: 'DHN',
    toStation: 'JSG',
    departureTime: '08:45',
  ...
  {
    id: '40',
    transportNumber: '18636',
    transportName: 'Jharsuguda - Dhanbad Express',
    transportType: 'train',
    fromStation: 'JSG',
    toStation: 'DHN',
    departureTime: '17:15',
  ...
  {
    id: '41',
    transportNumber: '58305',
    transportName: 'Ranchi - Giridih Passenger',
    transportType: 'train',
    fromStation: 'RNC',
    toStation: 'GRD',
    departureTime: '05:45',
  ...
  {
    id: '42',
    transportNumber: '58306',
    transportName: 'Giridih - Ranchi Passenger',
    transportType: 'train',
    fromStation: 'GRD',
    toStation: 'RNC',
    departureTime: '13:00',
  ...
  {
    id: '43',
    transportNumber: '18641',
    transportName: 'Patna - Dhanbad Express',
    transportType: 'train',
    fromStation: 'PNBE',
    toStation: 'DHN',
    departureTime: '06:30',
  ...
  {
    id: '44',
    transportNumber: '18642',
    transportName: 'Dhanbad - Patna Express',
    transportType: 'train',
    fromStation: 'DHN',
    toStation: 'PNBE',
    departureTime: '14:30',
  ...
  {
    id: '45',
    transportNumber: 'JH23',
    transportName: 'Ranchi - Giridih Express Bus',
    transportType: 'bus',
    fromStation: 'RNB',
    toStation: 'GRB',
    departureTime: '07:45',
  ...
  {
    id: '46',
    transportNumber: 'JH24',
    transportName: 'Giridih - Ranchi Express Bus',
    transportType: 'bus',
    fromStation: 'GRB',
    toStation: 'RNB',
    departureTime: '14:30',
  ...
  {
    id: '47',
    transportNumber: 'JH25',
    transportName: 'Dhanbad - Dumka Ordinary Bus',
    transportType: 'bus',
    fromStation: 'DHB',
    toStation: 'DMB',
    departureTime: '09:30',
  ...
  {
    id: '48',
    transportNumber: 'JH26',
    transportName: 'Dumka - Dhanbad Ordinary Bus',
    transportType: 'bus',
    fromStation: 'DMB',
    toStation: 'DHB',
    departureTime: '07:00',
  ...
  {
    id: '49',
    transportNumber: 'JH27',
    transportName: 'Jamshedpur - Hazaribagh Deluxe Bus',
    transportType: 'bus',
    fromStation: 'JMB',
    toStation: 'HZB',
    departureTime: '08:15',
  ...
  {
    id: '50',
    transportNumber: 'JH28',
    transportName: 'Hazaribagh - Jamshedpur Deluxe Bus',
    transportType: 'bus',
    fromStation: 'HZB',
    toStation: 'JMB',
    departureTime: '14:30',
  ...
  {
    id: '51',
    transportNumber: 'JH29',
    transportName: 'Bokaro - Hazaribagh Express Bus',
    transportType: 'bus',
    fromStation: 'BKB',
    toStation: 'HZB',
    departureTime: '10:00',
  ...
  {
    id: '52',
    transportNumber: 'JH30',
    transportName: 'Hazaribagh - Bokaro Express Bus',
    transportType: 'bus',
    fromStation: 'HZB',
    toStation: 'BKB',
    departureTime: '15:00',
  ...
  {
    id: '53',
    transportNumber: 'JH31',
    transportName: 'Deoghar - Dumka Ordinary Bus',
    transportType: 'bus',
    fromStation: 'DGB',
    toStation: 'DMB',
    departureTime: '08:45',
  ...
  {
    id: '54',
    transportNumber: 'JH32',
    transportName: 'Dumka - Deoghar Ordinary Bus',
    transportType: 'bus',
    fromStation: 'DMB',
    toStation: 'DGB',
    departureTime: '13:30',
  ...
  {
    id: '55',
    transportNumber: 'JH33',
    transportName: 'Gaya - Deoghar Express Bus',
    transportType: 'bus',
    fromStation: 'GYB',
    toStation: 'DGB',
    departureTime: '09:15',
  ...
  {
    id: '56',
    transportNumber: 'JH34',
    transportName: 'Deoghar - Gaya Express Bus',
    transportType: 'bus',
    fromStation: 'DGB',
    toStation: 'GYB',
    departureTime: '16:30',
  ...
  {
    id: '57',
    transportNumber: 'JH35',
    transportName: 'Patna - Ranchi AC Sleeper Bus',
    transportType: 'bus',
    fromStation: 'PNB',
    toStation: 'RNB',
    departureTime: '22:00',
  ...
  {
    id: '58',
    transportNumber: 'JH36',
    transportName: 'Ranchi - Patna AC Sleeper Bus',
    transportType: 'bus',
    fromStation: 'RNB',
    toStation: 'PNB',
    departureTime: '21:30',
  ...
  {
    id: '59',
    transportNumber: 'JH37',
    transportName: 'Jharsuguda - Ranchi Night Bus',
    transportType: 'bus',
    fromStation: 'JSG',
    toStation: 'RNB',
    departureTime: '21:00',
  ...
  {
    id: '60',
    transportNumber: 'JH38',
    transportName: 'Ranchi - Jharsuguda Night Bus',
    transportType: 'bus',
    fromStation: 'RNB',
    toStation: 'JSG',
    departureTime: '20:30',
